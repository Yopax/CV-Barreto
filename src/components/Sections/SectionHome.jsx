  ...
  return (
    <div>
      ...
      >
        <div>
        <img
            className="hidden mt-2 max-[320px]:mb-4 max-[425px]:mt-4 max-[320px]:mb-8 max-[320px]:mt-2 w-24 h-24 max-[320px]:w-14 max-[320px]:h-14 rounded-full shadow-lg max-[425px]:flex"
